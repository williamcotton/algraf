...
const SCALE_DOC_ARGS: &[ArgDoc] = &[
    ...
    ArgDoc {
        ...
        value: "string",
        default: None,
        doc: "Temporal legend-entry label format for categorical fill or stroke scales.",
    },
    ArgDoc {
        name: "label",
        value: "string",
...
const GENERATED_AXIS_ORIENTATION: &[Accept] = &[Accept::Enum(&["vertical", "horizontal"])];
...
const HISTOGRAM: &[PropSpec] = &[
    ...
    opt(PropertyKey::Orientation, GENERATED_AXIS_ORIENTATION),
...
pub fn property_doc(name: &str) -> &'static str {
    match name {
        ...
        "timeFormat" => "Temporal label format: `\"iso-date\"`, `\"iso-minute\"`, or a chrono-style pattern.",
