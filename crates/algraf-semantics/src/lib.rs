...
pub use ir::{
    ...
    FacetLabelModeIr, FacetScaleModeIr, FontStyleIr, FontWeightIr, FrameIr, GeometryIr,
    GeometryKind, GlyphCallIr, GlyphClipIr, GlyphHostRefIr, GlyphKeyIr, GlyphPlacementIr,
    GlyphScalePolicyIr, GlyphSizeIr, GradientIr, GradientStopIr, GridBinsIr, GridShapeIr, GuideIr,
    GuideOverridesIr, InteractionIr, IntervalOrientationIr, LegendPositionIr, LevelSpecIr,
    ...
    SmoothMethodIr, SpaceDataRef, SpaceIr, SpaceLayerIr, SpatialPredicateIr, StatCallIr, StatKind,
    StatOptionsIr, StepDirectionIr, SummaryReducerIr, TableDeclIr, TemporalFormatIr,
    TemporalTickIntervalIr, TemporalTickUnitIr, TextAlignIr, ThemeIr, ThemeLineIr, ThemeOverrides,
    ThemeRectIr, ThemeTextIr, PROPERTY_KEYS,
};
