    ...
    <div className={`site-shell site-route-${route}`}>
      <header className="site-header">
        <a className="site-brand" href={routeHref("/")} onClick={(event) => navigate("/", event)}>
          <span className="site-brand-mark">Ag</span>
          <span>
            <strong>Algraf</strong>
            <small>Grammar of graphics DSL</small>
          </span>
        </a>
        ...
        <a className="site-header-cta" href="https://github.com/williamcotton/algraf">
